...
Before doing this, you should create the file WEB-INF/db_creds.txt with your database credentials. The first line should be your username, and the second should be your password.
